...
<body>
    ...
    <div class="row">
             <div class="col-lg-12">
           	<div id="map" style="width:100%;height:500px; margin: 0 30px 0 0;">
	...
	var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
	    mapOption = {
	        center: new kakao.maps.LatLng(37.56778286685991, 126.98229676426686), // 지도의 중심좌표
	        level: 4 // 지도의 확대 레벨
	    };  
	...
	// 주소로 좌표를 검색합니다
	geocoder.addressSearch('서울시 중구 다동88', function(result, status) {
	    ...
	    // 정상적으로 검색이 완료됐으면 
	     if (status === kakao.maps.services.Status.OK) {
	        ...
	        var infowindow = new kakao.maps.InfoWindow({
	            content: '<div style="width:250px; height:70px; border: 1px solid black; text-align:center;padding:6px 6px 0 6px;"><div style="padding: 0 0 5px 0;"><strong>중구가 시키드나</strong></div><div>서울시 중구 다동 88 동아빌딩</div></div>'
	        });
            ...
            <div class="contact__address" style="margin: 40px 0 0 0;">
                <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="contact__text">
                        ...
                        <ul>
                            <li>Mon-Fri: 9:00am to 18:00pm</li>
                            <li>Sat-Sun: 연락불가</li>
                        </ul>
