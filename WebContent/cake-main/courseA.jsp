			...
			<div class="list-group" style = "max-width:100%; margin-left:15px; margin-right:15px; max-height:548px; overflow:scroll; -webkit-overflow-scrolling:touch">
				<a href="#"
					...
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">구 러시아공사관</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 정동 15-1</p> 
					<small style = "white-space:pre">구분: 국가지정문화재		건축연도: 1890년</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">구세군중앙회관</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 정동 1-23</p> 
					<small style = "white-space:pre">구분: 시지정문화재		건축연도: 1928</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">국회의사당(구)</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 태평로1가 60-1</p> 
					<small style = "white-space:pre">구분: 등록문화재			건축연도: 1935</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">서울특별시청사(구)</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 태평로1가 31</p> 
					<small style = "white-space:pre">구분: 등록문화재			건축연도: 1926</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">경운궁양이재</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 정동3</p> 
					<small style = "white-space:pre">구분: 등록문화재			건축연도: 1905</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">덕수궁</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 정동 5-1</p> 
					<small style = "white-space:pre">구분: 국가지정문화재		건축연도: 1593</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">대법원청사(구)</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 서소문동 37</p> 
					<small style = "white-space:pre">구분: 등록문화재			건축연도: 1928</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">배재학당동관</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 정동 34-5</p> 
					<small style = "white-space:pre">구분: 시지정문화재		건축연도: 1916	</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">정동교회</h5>	
					</div>
					<p class="mb-1">서울특별시 정동 34-3</p> 
				...
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">이화여자고등학교 심슨기념관</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 정동 32-1</p> 
					<small style = "white-space:pre">구분: 등록문화재			건축연도: 1915	</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">신아일보별관(구)</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 정동 1-28</p> 
					<small style = "white-space:pre">구분: 등록문화재			건축연도: 1930</small>
				</a>
				
				<a href="#"
					class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">미국공사관</h5>	
					</div>
					<p class="mb-1">서울특별시 중구 정동 10-1</p> 
					<small style = "white-space:pre">구분: 시지정문화재		건축연도: 1883</small>
				</a>
