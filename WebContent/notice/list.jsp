...
%>
	...
	<%
		...
		*/
		...
		cPage : 11-20 -> currentBlock : 2, pageDisplayCount : 10
		totalBlock = 2
		....
		totalPage : 13
				...
				<nav aria-label="Page navigation example">
				  <ul class="pagination justify-content-center">
				    ...
				    <li class="page-item <%if(currentBlock==1){ %>disabled"<%} %>>
				      <a class="page-link" href="list.jsp?page=<%=start %> %>" tabindex="-1" aria-disabled="true">Previous</a>
				    </li>
